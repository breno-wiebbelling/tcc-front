...
export default () => {
  ...
  columnLibrary.getGapColumn = (currentIndex, totalLength) => {
  ...
  columnLibrary.formatNewColumn = (currentIndex, totalLength, parentColumnName) => {
    let gapResult = columnLibrary.getGapColumn(currentIndex, totalLength)
